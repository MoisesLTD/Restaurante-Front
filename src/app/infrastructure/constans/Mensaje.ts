export class Mensaje {
  public static notUserEmpty = "Ingrese su código de membresía";
  public static notPassEmpty = "Ingrese su contraseña";
  public static notUserExist = "Código no registrado en el sistema";
